...
=== Worklist! The open source CV hosting and editing tool!
...
=== End to end deployment ( currently only supporting heroku deploys )
...
First [log in to your heroku toolbelt]( and create an app like:

    heroku create worklist-{fooname} --region eu
    heroku config:set BUNDLE_WITHOUT="development:test"
    git push heroku master
    heroku run rake --trace db:migrate

Now visit the app, it should all be working.
