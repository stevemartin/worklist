...
= Rails 5 Webpacker Upgrade

Read https://github.com/rails/webpacker#usage for some background on how to write stuff

All webpack managed content lives in app/javascript/packs app/javascript/css etc
